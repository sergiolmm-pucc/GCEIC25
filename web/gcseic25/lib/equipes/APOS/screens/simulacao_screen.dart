...
class _SimulacaoScreenState extends State<SimulacaoScreen> {
  ...
  // IMPORTANTE:
  // - Para Web (Chrome/Edge): 'http://localhost:3000' (se o Node.js estiver na mesma máquina)
  // - Para Emulador Android: 'http://10.0.2.2:3000' (aponta para o localhost da sua máquina host)
  // - Para Dispositivo Físico: 'http://SEU_IP_DA_MAQUINA:3000' (ex: 'http://192.168.1.100:3000')
