...
class CustoMensalScreen extends StatefulWidget {
  const CustoMensalScreen({super.key});

  @override
  State<CustoMensalScreen> createState() => _CustoMensalScreenState();
}

class _CustoMensalScreenState extends State<CustoMensalScreen> with TickerProviderStateMixin {
  ...
  Future<void> _buscarCustoMensal() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success' && data['data'] != null) {
          setState(() {
            _custoMensal = (data['data']['custoMensal'] as num).toDouble();
          });
        } else {
          setState(() {
                                  ...
                                  Transform.translate(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Material(
                                        ...
                                        child: InkWell(
                                          onTap: _loading ? null : _buscarCustoMensal,
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              'R\$ ${_custoMensal!.toStringAsFixed(2)}',
                                              style: const TextStyle(
                                                fontSize: 32,
                                                fontWeight: FontWeight.bold,
                                                color: Color(0xFFE97A12),
                                            ...
                                            Text(
                                              'Valor total incluindo todos os encargos',
                                              style: TextStyle(
